...
print('The End!')
print('')
print('I hope you had fun (or at least ended more confused than when you started, haha)! This game was coded by me, [my name]! Find me on github @ [insert github user here]!')
